...
public class Hero extends FaherObjects implements IDrawable, IMovable {
    ...
    public void resetall() {
        ...
        this.score = 0;
        this.levelName = null;
        this.cord_X_Life = new int[]{0, 200, 200, 0};
        this.cord_Y_Life = new int[]{50, 50, 80, 80};
        this.cord_x_linea = new int[]{0, 800, 800, 0};
        this.cord_y_linea = new int[]{lineHeigth, lineHeigth, lineHeigth + 5, lineHeigth + 5};
